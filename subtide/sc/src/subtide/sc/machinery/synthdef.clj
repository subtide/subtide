(ns subtide.sc.machinery.synthdef
...
(defn synthdef? [obj]
  (contains? #{:subtide.sc.machinery.synthdef/synthdef
               :subtide.sc.machinery.synthdef/imported-synthdef}
             (type obj)))
...
;; created by Subtide and then loaded into the synth server using the synth
;; and inst forms and their derivatives.
(defn load-synthdef
  "Synchronously load an Subtide synth definition onto the audio
