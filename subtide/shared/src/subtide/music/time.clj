...
(defn after-delay
  ...
  ([ms-delay fun]
   (after-delay ms-delay fun "Subtide delayed fn"))
...
(defn periodic
  ...
  ([ms-period fun initial-delay] (periodic ms-period fun initial-delay "Subtide periodic fn"))
...
(defn interspaced
  ...
  ([ms-period fun initial-delay] (interspaced ms-period fun initial-delay "Subtide interspaced fn"))
  ([ms-period fun initial-delay description]
...
;; Ensure all scheduled player fns are stopped when Subtide is reset
