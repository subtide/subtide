...
(defonce ^:private handler-pool (handlers/mk-handler-pool "Subtide Event Handlers"))
...
(defn on-event
  ...
  Handlers can return :subtide/remove-handler to be removed from
...
(defn on-sync-event
  ...
  Handlers can return :subtide/remove-handler to be removed from the
