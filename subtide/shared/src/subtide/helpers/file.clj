...
(defn print-if-verbose
  ...
  [& to-print]
  (when *verbose-subtide-file-helpers*
    (when (integer? *verbose-subtide-file-helpers*)
      (dotimes [_ *verbose-subtide-file-helpers*] (print " ")))
...
(defn- remote-file-copy
  ...
  statements when *verbose-subtide-file-helpers* is bound to true."
...
(defn download-file
  ...
  Verbose mode is enabled by binding *verbose-subtide-file-helpers* to true."
  ([url path]
