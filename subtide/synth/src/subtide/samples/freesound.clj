(ns subtide.samples.freesound
  ...
  (:require
   ...
   [subtide.samples.freesound.gui :as gui]
   ...
   [subtide.helpers.lib :refer [defrecord-ifn]]
   [subtide.libs.asset :as asset]
   [subtide.sc.buffer :as buffer]
   [subtide.sc.sample :as samp])
  (:import
