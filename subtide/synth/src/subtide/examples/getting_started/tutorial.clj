(ns subtide.examples.getting-started.tutorial
  (:use subtide.live))

; Welcome to Subtide

; For starters lets just make some noise and get the basics of working with
; Subtide figured out.  Subtide is implemented in Clojure, and it uses the
...
; In Subtide you create synthesizers to generate audio.  You can think of a
