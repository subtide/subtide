(ns
  ...
  (:use [clojure.java.io :only [file]]
        ...
        [subtide.sc.node]
        [subtide.sc.machinery.allocator]
...
(defn load-samples
  "Takes one or more directory and/or file paths,
   suppoerts glob or glob paths (see #'subtide.helpers.file/glob)
...
(defn load-samples-async
  "Takes one or more directory and/or file paths,
   supports glob paths (see #'subtide.helpers.file/glob).
...
(derive ::sample :subtide.sc.buffer/file-buffer)
