...
(defonce ^:private ^Logger ROOT-LOGGER (Logger/getLogger "subtide"))
(defonce ^:private ^FileHandler LOG-FILE-HANDLER (FileHandler. store/SUBTIDE-LOG-FILE (int LOG-LIMIT) (int LOG-COUNT) ^boolean LOG-APPEND))
