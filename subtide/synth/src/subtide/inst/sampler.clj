(ns subtide.inst.sampler
  (:use [subtide.sc synth envelope ugens]
        [subtide.music pitch]))
...
; (
; s.sendMsg("/b_allocRead", 0, "/home/rosejn/projects/subtide/instruments/samples/kit/boom.wav");
; s.sendMsg("/b_allocRead", 1, "/home/rosejn/projects/subtide/instruments/samples/kit/open-hat.wav");
; s.sendMsg("/b_allocRead", 2, "/home/rosejn/projects/subtide/instruments/samples/kit/crikix.wav");
; )
;
; (
...
#_(defn test-flute []
    (defonce flute (load-sample (load-sample "/home/rosejn/projects/subtide/instruments/samples/flutes/flutter-flute-1.wav")))
    (hit flute :dur 2.0))
