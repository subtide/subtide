(ns subtide.sc.core-test
  (:require
    [clojure.test :refer [deftest is use-fixtures]]
    [subtide.sc.server :refer [boot-server status kill-server]]
    [subtide.sc.node :refer [group group-free]]
    [subtide.sc.machinery.server.connection :refer [connection-info*]]
    [subtide.music.time :refer [now]]
