(ns subtide.examples.buses.getonthebus
  (:use subtide.live))
...
;; Subtide, it should be pretty manageable. You should be able to see the tri-synth
;; and sin-synth within the early birds group, which itself is within the
;; get-on-the-bus main group which itself is within the Subtide Default group.
