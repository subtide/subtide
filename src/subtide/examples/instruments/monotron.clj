(ns subtide.examples.instruments.monotron
  (:use subtide.live))
...
;;   via some code in https://github.com/rogerallen/explore_subtide
;;
;; Source
...
;; https://github.com/subtide/subtide/blob/master/src/subtide/inst/synth.clj
;;
;; Inspiration
