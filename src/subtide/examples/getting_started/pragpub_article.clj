...
;; Subtide (http://subtide.github.io). Once you reach the end, you'll
...
;; `insane-sounds/project.clj` and add Subtide as a dependency. The file
...
;; connection as it will download all of Subtide's dependencies
;; (including the SuperCollider synthesis server) and then boot you into
;; a Clojure REPL. You should see the following prompt:

;; user=>

;; Now you can start and boot Subtide by typing and entering:
...
;; numbers, Subtide provides a handy function:
...
;; `~/.subtide`. Therefore the next time you access this particular
...
;; Subtide has an excellent solution for this issue - temporal
...
;; So, how can we have more fun than this? Typically in Subtide land,
